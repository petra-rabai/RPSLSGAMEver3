...
namespace RPSLSGAMEver3
{
    public class GameBoard
    {
        ...
        public void GameHelp(in GameContent gameContent)
        {
        ...
        public void GameFinalize(in GameContent gameContent)
        {
